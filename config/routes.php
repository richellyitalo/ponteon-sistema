...
Router::scope('/', function (RouteBuilder $routes) {
    ...
    $routes->connect('/contatos', ['controller' => 'Contacts', 'action' => 'index']);
    $routes->connect('/contatos/novo', ['controller' => 'Contacts', 'action' => 'add']);
    $routes->connect('/contatos/editar/:id', ['controller' => 'Contacts', 'action' => 'edit'])
           ->setPatterns(['id' => '\d+'])
           ->setPass(['id']);
